...
#+BEGIN_SRC asm :tangle stage0-machine-arm.s
  ...
  .macro entry name:req, label:req, imm=0, hid=0
...
#+BEGIN_SRC asm :tangle stage0-machine-arm.s
  ...
  .endm
  .macro fasmstart name:req, label:req, pops, insts:vararg
    entry \name, \label
    fw 1f
  1: .ifnc _,\pops ; pop {\pops} ; .endif
    inst \insts
  .endm
  .macro fasmend pushes
    .ifnc _,\pushes ; push {\pushes} ; .endif
    b next
  .endm
  .macro fasm name:req, label:req, pop, push, i:vararg
    fasmstart \name, \label, \pop, \i
    fasmend \push
  .endm

  .macro binops name:req, label:req, op:req, rest:vararg
    fasm \name, \label, r0-r1, r1, "\op r1, r0"
    .ifnb \rest ; binops \rest ; .endif
  .endm
  .macro binrels name:req, label:req, rel:req, rest:vararg
...
#+BEGIN_SRC asm :tangle stage0-machine-arm.s
  ...
  fasm "NEGATE", NEGATE, r0, r0, "rsb r0, #0"
  fasm "INVERT", INVERT, r0, r0, "mvn r0, r0"
  ...
  fasm "BRANCH", BRANCH, _, _, "ldr r0, [next_inst]" /* FWSIZE */
  ...
  fasm "NIP", NIP, r0-r1, r1
  fasm "DROP", DROP, _, _, "sub sp, #4" /* CELLSIZE */
  fasm "DUP", DUP, _, r0, "ldr r0, [sp]"
  fasm "OVER", OVER, _, r0, "ldr r0, [sp, #4]" /* CELLSIZE */
  fasm "PICK", PICK, r0, r0, "ldr r0, [sp, r0]"
  fasm "ROT", ROT, r0-r2, r0-r1, "push {r2}"
  fasm "SWAP", SWAP, r0-r1, r1,"push {r0}"
...
{{{cstart}}}
#+BEGIN_SRC asm :tangle stage0.s
  entry "ENTRY->INTERPRETER", ENTRY_TO_INTERPRETER
    fw forth_interpreter
