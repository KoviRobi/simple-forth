...
#+BEGIN_SRC asm :tangle stage0.s
  ...
  fdef "2>R", TWO_TO_R, R_FROM, ROT, ROT, SWAP, TO_R, TO_R, TO_R
  fdef "2R>", TWO_R_FROM, R_FROM, R_FROM, R_FROM, SWAP, ROT, TO_R
  fdef "2RDROP", TWO_R_DROP, R_FROM R_FROM, R_FROM, TWO_DROP, TO_R
  fdef "2R@", TWO_R_FETCH, TWO_R_FROM, TWO_DUP, TWO_TO_R
  fdef "TRUE", _, LIT, -1
  fdef "FALSE", _, LIT, 0
